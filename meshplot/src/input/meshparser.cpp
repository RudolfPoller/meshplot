...
namespace yy {
      ...
      switch (yyr1_[yyn])
    {
      ...
      try
#endif // YY_EXCEPTIONS
        {
          switch (yyn)
            {
  case 12: // node: label coordinates EOLN
                                                {
  ...
  case 13: // coordinates: coord coord
                                                { coords[2] = 0.0f; }
    break;

  case 18: // element: label nodelabs EOLN
                                                {
  ...
  case 19: // nodelabs: label label label add_nodelabs
                                                {
						  serial l;
						  l = labels[3];
						  corners.push_front(
  ...
  case 21: // add_nodelabs: add_nodelabs label
                                                {
  ...
  case 24: // coord: REALNUM
                                                { coords[cix++] = yystack_[0].value.as < GLfloat > (); }
    break;

  case 25: // coord: POSINT
  ...
  parser::yypact_[] =
  {
     -22,     1,   -22,     0,     7,   -22,   -22,   -22,   -22,   -22,
      15,   -22,    11,    -1,   -22,   -22,   -22,   -22,   -22,     6,
      11,     7,   -22,   -22,   -22,    11,    17,   -22,     7,   -22,
     -22,   -22,    16,     7,   -22,     7,   -22,     7,   -22
  };

  const signed char
  parser::yydefact_[] =
  {
       2,     0,     1,     0,     0,     4,     3,     7,     5,    22,
       0,    10,     0,     0,     9,    11,    25,    24,    23,     0,
       0,     0,     8,     6,    12,    13,     0,    16,     0,    14,
      15,    17,     0,     0,    18,     0,    20,    19,    21
  };

  const signed char
  parser::yypgoto_[] =
  {
     -22,   -22,   -22,   -22,   -22,   -22,    14,   -22,   -22,   -22,
       2,   -22,   -22,   -21,   -14
  };
  ...
  parser::yytable_[] =
  {
      28,     2,     3,    21,     4,    28,    25,    33,    22,     8,
       5,    29,    35,     9,    36,    24,    38,    16,    17,    18,
      14,     9,    30,     9,    15,    34,     0,     0,    31
  };

  const signed char
  parser::yycheck_[] =
  {
      21,     0,     1,     4,     3,    26,    20,    28,     9,     9,
       9,    25,    33,     6,    35,     9,    37,     6,     7,     8,
       5,     6,     5,     6,    10,     9,    -1,    -1,    26
  };
  ...
  parser::yystos_[] =
  {
       0,    11,     0,     1,     3,     9,    12,    14,     9,     6,
      15,    16,    23,    13,     5,    16,     6,     7,     8,    17,
      24,     4,     9,    18,     9,    24,    19,    20,    23,    24,
       5,    20,    21,    23,     9,    23,    23,    22,    23
  };

  const signed char
  parser::yyr1_[] =
  {
       0,    10,    11,    11,    11,    11,    12,    13,    13,    14,
  ...
  {
  "\"end of file\"", "error", "\"invalid token\"", "NODESET_BEGIN",
  "ELEMSET_BEGIN", "SET_END", "POSINT", "REALNUM", "ZERO", "EOLN",
  "$accept", "list", "mesh", "eofs", "nodeset", "node_block", "node",
  "coordinates", "elemset", "element_block", "element", "nodelabs",
  "add_nodelabs", "label", "coord", YY_NULLPTR
  };
#endif
  ...
  parser::yyrline_[] =
  {
       0,    59,    59,    60,    61,    62,    64,    66,    67,    69,
      71,    72,    74,    82,    84,    86,    88,    89,    91,    98,
     115,   116,   122,   125,   127,   129
  };
